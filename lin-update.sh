...
grep -ri -m 20 --exclude="LinEnum-ng.sh" --exclude="linpeas.sh" --exclude="lin-update.sh" --exclude="*.js" --exclude="*.css" --exclude="*.scss" --exclude="*.template" --exclude="*.templates" "password\|passwd\|pwd" /var/www /etc/*.conf /home/*/.ssh 2>/dev/null | grep -v "Binary"
...
aws_keys=$(grep -rli --exclude="LinEnum-ng.sh" --exclude="linpeas.sh" --exclude="lin-update.sh" --exclude="*.js" --exclude="*.css" --exclude="*.scss" --exclude="*.template" --exclude="*.templates" "aws_secret_access_key\|aws_access_key_id" /home /root 2>/dev/null | head -10)
if [ "$aws_keys" ]; then
...
api_hits=$(grep -rih \
    ...
    --exclude="LinEnum-ng.sh" --exclude="linpeas.sh" --exclude="lin-update.sh" --exclude="*.js" --exclude="*.css" --exclude="*.scss" --exclude="*.template" --exclude="*.templates" \
...
grep -rl --exclude="LinEnum-ng.sh" --exclude="linpeas.sh" --exclude="lin-update.sh" --exclude="*.js" --exclude="*.css" --exclude="*.scss" --exclude="*.template" --exclude="*.templates" "PRIVATE KEY-----" /home /root 2>/dev/null | head -10 | while read keyfile; do
...
if [ -n "$USERNAME" ]; then
    ...
    content_hits=$(grep -rIl --exclude="LinEnum-ng.sh" --exclude="linpeas.sh" --exclude="lin-update.sh" --exclude="*.js" --exclude="*.css" --exclude="*.scss" --exclude="*.template" --exclude="*.templates" \
...
if [ ${#shell_users[@]} -eq 0 ]; then
    ...
    for uname in "${shell_users[@]}"; do
        ...
        for dir in "${hunt_dirs[@]}"; do
            [ -d "$dir" ] || continue
            hits=$(grep -rIl --exclude="*.js" --exclude="*.css" --exclude="*.scss" --exclude="*.template" --exclude="*.templates" --exclude="linpeas.sh" --exclude="LinEnum-ng.sh" --exclude="lin-update.sh" "$uname" "$dir" 2>/dev/null | grep -vE "\.log$|/proc/|/sys/" | head -10)
